            ...
            <div class="container">
                <div class="responsive__cart-area">
                    <!-- <form class="cart__form"> -->
					   ...
					   ?>
                        <form action="portpayment.php" method="post">
                                <input text="text" hidden name="total_vnpay" value="<?php echo $gtotal?>"/>
                                <button class="button" name="redirect" id="redirect">Thanh toán VNPAY</button>
                         </form>
